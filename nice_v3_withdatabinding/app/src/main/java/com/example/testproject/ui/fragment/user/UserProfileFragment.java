...
//        ViewUtils.fillDataInSpinner(this,binding.boxRole.spinner, Arrays.asList(getResources().getStringArray(R.array.user_role)));
    ...
    private void  fillDataInEd(EditText editText, String txt, boolean enable, ConstraintLayout cl){
        ...
        if (enable){
            cl.setBackgroundResource(R.drawable.white_ractangle_border);
            binding.boxGender.layInputBox.setBackgroundResource(R.drawable.white_ractangle_border);

        }else {
            cl.setBackgroundResource(R.drawable.custom_button_two);
            binding.boxGender.layInputBox.setBackgroundResource(R.drawable.custom_button_two);
