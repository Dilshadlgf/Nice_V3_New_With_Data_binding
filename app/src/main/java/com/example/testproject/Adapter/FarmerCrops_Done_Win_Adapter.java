...
//                    dashboardVH.Completed_Date.setText(CommonUtils.getDateFormat(model.getCompletedDate()));
...
//                            mainOb1.addProperty("farmer",loginDao);
//
...
//                    JsonObject mainObj=new JsonObject();
//                    mainObj.addProperty("area",binding.sparearea.getSelectedItem().toString());
...
//                    mainObj.addProperty("irrigation",croplist.get(currentCard).getIrrigation());
